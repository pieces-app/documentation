...
const baseSidebarItems: {
  ...
  },
  {
    ...
    items: [
      ...
      // // { type: 'doc', id: 'docs/apis/ActivitiesApi', label: 'Activities API' },
      // { type: 'doc', id: 'docs/apis/ApplicationsApi', label: 'Applications API' },
      // { type: 'doc', id: 'docs/apis/AssetsApi', label: 'Assets API' },
      // { type: 'doc', id: 'docs/apis/ConnectorApi', label: 'Connector API' },
      // { type: 'doc', id: 'docs/apis/ConversationsApi', label: 'Conversations API' },
      // // { type: 'doc', id: 'docs/apis/ModelsApi', label: 'Models API' },
      // // { type: 'doc', id: 'docs/apis/OSApi', label: 'OS API' },
      // // { type: 'doc', id: 'docs/apis/SearchApi', label: 'Search API' },
      // { type: 'doc', id: 'docs/apis/WellKnownApi', label: 'WellKnown API' },
    ]
  },
  {
    type: 'category',
    ...
    items: [
      ...
      // // { type: 'doc', id: 'docs/models/Activity', label: 'Activity' },
      // { type: 'doc', id: 'docs/models/Application', label: 'Application' },
      // { type: 'doc', id: 'docs/models/Asset', label: 'Asset' },
      // { type: 'doc', id: 'docs/models/Conversation', label: 'Conversation' },
      // // { type: 'doc', id: 'docs/models/Model', label: 'Model' },
      // // { type: 'doc', id: 'docs/models/SearchedAssets', label: 'Searched Assets' },
    ]
  }
];
