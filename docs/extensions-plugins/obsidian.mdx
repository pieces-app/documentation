...
We just launched brand new [documentation for the Pieces for Obsidian Plugin](https://docs.pieces.app/products/obsidian)!

Check it out on our new documentation site and leave us some feedback.

<CTAButton
  href="https://docs.pieces.app/products/extensions-plugins/obsidian"
