...
/>
export const ObsidianLogo = props => {
    return <img style ={{marginTop: "0px", marginBottom: "1em", width: "50%"}} src={"/assets/obsidian_logo.png}/>
}
...
<GridFlexRowBaseline>
<ObsidianLogo src="/assets/obsidian_logo.png"></ObsidianLogo>
