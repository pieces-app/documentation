...
One of the most significant features of this plugin is qGPT, an artificial intelligence assistant designed to assist with your personal knowledge management.
...
- Each response from the qGPT will also contain links to the relevant notes that it used to answer your question. Click on one of those links in order to open that markdown file in your editor.
