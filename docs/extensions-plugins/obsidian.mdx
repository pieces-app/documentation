...
## qGPT - Personal Knowledge Assistant
One of the most significant features of this plugin is the introduction of qGPT, an artificial intelligence assistant designed to assist with your personal knowledge management.
qGPT learns from the notes in your vault, and adapts to the context of what you're working on. To try out this impressive technology: 

- Ensure POS is open, and updated to at least 5.1.2
- To view qGPT, open the pieces plugin and click the bot logo on the top slider to switch to Copilot
- The copilot will load in your entire vault as context for the chatbot. This means you can query your Obsidian vault completely with plain text and we will semantically match your question to the relevant notes you have.
- Simply begin asking questions in the input text prompt regarding your notebooks and watch the magic!
...
- Each response from the qGPT will also contain links to the relevant notes that it was able to gain context from in order to answer your question, click on one of those links in order to open that markdown file in your editor.
...
- **Offline First in qGPT**: qGPT sends data to ChatGPT for its more complex processing. Understandably, that can be a bit scary, because your vault information may be private. **We plan to make qGPT fully offline by Q3***, but for now, we've found an effective compromise. Rather than sending all your data to ChatGPT, we use a series of offline models to boil things down as much as possible. This way, we only send the bare minimum to the cloud, and the majority of ML processing is safely kept on your computer. To understand how this works internally, refer to the diagram  below.
