...
1. Plugins in Obsidian Make sure you have community plugins enabled in Obsidian.
2. Go to Pieces for Developers in the Obsidian community plugin store.
...
5. Now you can get started with the plugin! Just click the pieces icon on the left, and open up your right side ribbon in Obsidian to start the magic!
