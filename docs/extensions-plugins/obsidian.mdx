...
<Image zoom src="./assets/obsidian/OBSIDIAN_RIGHTCLICK.gif" alt="Example of saving a snippet using the obsidian Pieces plugin." />
...
<Image zoom src="./assets/obsidian/OBSIDIAN_SEARCH.gif" alt="Example of searching for snippets using the obsidian Pieces plugin." />
...
<Image zoom src="./assets/obsidian/OBSIDIAN_VIEWPIECE.gif" alt="Example of using a snippet that's been saved to Pieces." />
...
<Image zoom src="./assets/obsidian/OBSIDIAN_SHARE.gif" alt="Example of sharing a snippet using the obsidian Pieces plugin." />
...
<Image zoom src="./assets/obsidian/OBSIDIAN_SAVE.gif" alt="Example of using the embedded buttons added by the obsidian pieces plugin." />
...
_If none of the above fix your issue, please <a target="_blank" href="https://getpieces.typeform.com/to/mCjBSIjF#os=xxxxx&page=docs-obsidian">submit this form</a> and we'll get back to you!_
