...
- Each response from the Copilot will also contain links to the relevant notes that it was able to gain context from in order to answer your question, click on one of those links in order to open that markdown file in your editor.
