...
export const GitHubPill = (props) => {
  return (
    <a
      style={{ textDecoration: "none" }}
      target="_blank"
      href={"https://github.com/pieces-app/obsidian-pieces"}
    >
      <div style={{ maxWidth: "fit-content", minWidth: "fit-content" }}>
        <p
          class="dark:text-white text-black"
...
<GridFlexRow>
  ...
  <GitHubPill children="GitHub Link"></GitHubPill>
</GridFlexRow>
...
release: [Installation Instructions](https://github.com/pieces-app/obsidian-pieces#install-instructions)
