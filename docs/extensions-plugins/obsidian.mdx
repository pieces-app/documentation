...
_Pieces offers sorting by recent commits and by language!_
...
_After installing or updating your software, please restart Obsidian. If none of the above fix your issue, please <a target="_blank" href="{{ links.socials.support_email }}">send us an email</a> and we'll get back to you!_
