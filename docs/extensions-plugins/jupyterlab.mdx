...
<Accordian title="Install Using Pip">
...
2. (optional) Be Sure to have extensions enabled. [Read about enabling Extensions here](https://tljh.jupyter.org/en/latest/howto/admin/enable-extensions.html)
  -Be sure to accept the disclaimer before moving forward in this process.
</Accordian>
<Accordian title="Install via Pypi">
...
3. (optional) Be Sure to have extensions enabled. [Read about enabling Extensions here](https://tljh.jupyter.org/en/latest/howto/admin/enable-extensions.html)
    -Be sure to accept the disclaimer before moving forward in this process.
