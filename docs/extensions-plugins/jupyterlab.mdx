...
/>
export const JupyterLabLogo = props => {
    return <img style ={{marginTop: "0px", marginBottom: "1em", width: "50%"}} src={"/assets/jupyterlab_logo.png}/>
}
...
<GridFlexRowBaseline>
<JupyterLabLogo src="/assets/jupyterlab_logo.png"></JupyterLabLogo>
    <h1>Pieces JupyterLab Plugin</h1>
</GridFlexRow Baseline>

<GridFlexRow>
    <InstallButton>Get the JupyterLab Plugin</InstallButton>
    <ReleasePill children="Current Version: {{ versions.jupyterlab }}"></ReleasePill>
</GridFlexRow>
...
### Realtime Streaming
Any changes you make across any Pieces integration (e.g., the Pieces Desktop App, the Pieces VS Code Extension, the Pieces JupyterLab Plugin, etc.) will automatically be reflected in the JupyterLab plugin.
