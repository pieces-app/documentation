...
_The [Pieces Suite](/installation-getting-started/what-am-i-installing) must be downloaded and installed separately from the JupyterLab Extension for it to work properly._
...
If none of the above fix your issue, please [submit this form](https://getpieces.typeform.com/jupyterlab) and we'll get back to you!
