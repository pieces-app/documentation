---
title: Pieces for Developers JupyterLab Plugin
...
export const InstallButton = (props) => {
  return (
    <a
      ...
      target="_blank"
      href="{{ links.extensions.jupyterlab }}"
    >
...
<GridFlexRow>
  ...
  <ReleasePill src="https://github.com/pieces-app/obsidian-pieces" children="Current Version: {{ versions.obsidian }}"></ReleasePill>
</GridFlexRow>
...
1. Install `Obsidian42 - BRAT` from the Community Plugins in Obsidian
2. Go to the `Obsidian42 - BRAT` plugin settings
3. Click `Add Beta Plugin`
4. Enter `https://github.com/pieces-app/obsidian-pieces` into the input
5. Click `Add Plugin`
6. Enable `Auto-update plugins at startup` in the BRAT plugin settings
7. Go back to Community Plugins and enable the `Pieces For Developers` plugin
