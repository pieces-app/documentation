...
- Interact with the Pieces Copilot and recieve answers that are specific to your notebooks.
...
### Realtime Streaming
- All of the changes you make across any Pieces integration (e.g., the Pieces Desktop App, the Pieces VS Code Extension, the Pieces JetBrains Plugin, etc.) wil automatically be reflected in the JupyterLab plugin.
