...
export const ReleasePill = props => {
  return <a target="_blank" style={{textDecoration: "none"}}
            href="{{ links.installation.jupyterlab }}">
...
<ReleasePill>Compatible with JupyterLab 4.0.0 and higher and is currently in Beta</ReleasePill>
...
<Tabs
  defaultValue={"pypi"}
  values={[
    {label: 'PYPI Manager', value: 'pypi'},
    {label: 'pip', value: 'pip'},
    {label: 'conda', value: 'conda'}
  ]}
>
  <TabItem value="pypi">
    1. Search for `jupyterlab-pieces`

    2. Click the _Install_ button for the  `jupyterlab-pieces` extension

    3. Refresh your browser window
  </TabItem>
  <TabItem value="pip">
    1. Run this command
    `pip install -U jupyterlab-pieces`

    2. Enable the extension
    `jupyter nbextension enable --py jupyterlab-pieces`
  </TabItem>
  <TabItem value="conda">
    1. Run this command
    `conda install -c conda-forge jupyterlab-pieces`
...
<Image
  zoom
  src="/assets/jupyterlab/jupyterlab_screenshot.png"
