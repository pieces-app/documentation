...
export const FireFoxLogo = props  => {
    return <img style={{ marginTop: "0px", marginBottom: "1em", width: "50%" }} src={ "/assets/firefox_logo.png" }/>
}
...
<GridFlexRowBaseline>
<FireFoxLogo src="/assets/firefox_logo.png"></FireFoxLogo>
