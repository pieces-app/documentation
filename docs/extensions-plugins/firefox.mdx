...
In order to save code with the Pieces Firefox Addon, you must have <a target="blank" href="/docs/installation-getting-started/what-am-i-installing#what-is-pieces-os">Pieces OS and the Pieces for Developers desktop app.</a>
...
1. When you save a code snippet, website, or other asset from a website, they are viewable in the Pieces desktop app and are stored in [Pieces OS](/docs/installation-getting-started/pieces-os).
...
1. Pieces OS isn't running.
    ...
    - If you need to download and install Pieces OS, [visit this link](/docs/installation-getting-started/pieces-os).
