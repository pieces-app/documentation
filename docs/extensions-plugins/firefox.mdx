...
description: Learn about the Pieces Firefox Addon, how it functions, and what all you can do with this powerful extension in Mozilla Firefox.
---

<link rel="canonical" href="https://docs.pieces.app/extensions-plugins/firefox" />

export const InstallButton = props => {
    return <a style={{textDecoration: "none"}} target="_blank" href="{{ links.extensions.firefox }}">
...
<GridFlexRowBaseline>
    <h1>Pieces Firefox Addon</h1>
</GridFlexRowBaseline>

<GridFlexRow>
    <InstallButton>Get the Firefox Addon</InstallButton>
    <ReleasePill children="Current Version: {{ versions.firefox }}"></ReleasePill>
</GridFlexRow>

Using the Pieces Firefox Extension in parallel with the Pieces Desktop App makes it easier to save code as you move from website to website, and brings your copilot even closer to your workflow.

<Image zoom src="https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/WEB/MACOS/SAVE_TO_PIECES/16X9/PIECES_FOR_DEVELOPERS-WEB-SAVE_TO_PIECES-MACOS-16X9-11_20_2023.GIF" />

## Installing the Extension

<Info>In order to save code with the Pieces Firefox Addon, you must have <a target="blank" href="https://docs.pieces.app/installation-getting-started/what-am-i-installing#what-is-pieces-os">Pieces OS and the Pieces for Developers desktop app.</a></Info>
...
Once you have added it to Firefox, refresh your browser, and you'll see the Pieces buttons appear below code blocks on the web.

## Saving Snippets with the Pieces Firefox Addon

![The Pieces Web Extension Button for saving.](/assets/chrome/copy_and_save.png)
...
1. When you save a code snippet, website, or other asset from a website, they are viewable from the Pieces desktop app and are store in [Pieces OS](https://docs.pieces.app/installation-getting-started/pieces-os).
...
To view your snippets simply open the Pieces Desktop App to scroll through your snippets.

## Sharing Code with the Pieces Firefox Addon

![The Pieces Web Extension Button for sharing.](/assets/chrome/share.png)
...
By using the Pieces Copilot in the Pieces Firefox Addon, you can chat with the copilot about any code you find on the web. You can chat with the Pieces Copilot in the extension popover menu, but we like opening the Pieces Copilot in the Firefox side panel.
...
When you click the Pieces icon to open the extension popover menu, you'll see all of the snippets that the Pieces Firefox Addon has discovered on that webpage. From this menu, you can easily save any relevant snippets without scrolling back through long pages.
...
1. Pieces OS isn't running.
    ...
    - If you need to download and install Pieces OS, [visit this link](https://docs.pieces.app/installation-getting-started/pieces-os).
2. You disabled the Pieces buttons on that website.
    ...
    ![settings inside of Pieces Firefox Extension](/assets/chrome_settings.png)
...
![Changing the Theme of the Pieces Firefox Addon](/assets/theme_for_chrome.png)
...
1. Click the Extensions button in the top right corner of your Firefox window
