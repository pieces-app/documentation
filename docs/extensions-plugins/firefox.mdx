...
> 1. Right-click & select "allow permissions for Pieces..." with a Pieces "P" accompanying the action
> 2. Permissions will then be added, **refresh your browser**, and buttons will now be around the example snippet or other snippets in your browser!
