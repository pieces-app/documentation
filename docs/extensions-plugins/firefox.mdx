...
1. When you save a code snippet, website, or other asset from a website, they are viewable in the Pieces desktop app and are stored in [Pieces OS](https://docs.pieces.app/installation-getting-started/pieces-os).
...
3. This website doesn't have detectable code.
    - The code on this site might rendered in a way we haven't encountered before! Please send us the site and we'll work on supporting it.
