...
export const InstallButton = props => {
    return <a style={{textDecoration: "none"}} target="_blank" href={pieces_app.links.extensions.firefox}>
...
<Image src="https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/WEB/MACOS/SAVE_TO_PIECES/16X9/PIECES_FOR_DEVELOPERS-WEB-SAVE_TO_PIECES-MACOS-16X9-11_20_2023.GIF" />

## Installing the Addon

:::info

In order to save code with the Pieces Firefox Addon, you must have <a target="blank" href="https://docs.pieces.app/installation-getting-started/what-am-i-installing#what-is-pieces-os">Pieces OS and the Pieces for Developers desktop app.</a>
