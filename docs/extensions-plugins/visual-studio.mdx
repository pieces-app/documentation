...
You can install the Visual Studio Extension through the <a target="blank" href={pieces_app.links.extensions.visual_studio_ide}>Visual Studio Marketplace</a> or by searching for Pieces in the plugins search of your IDE.
...
If you're using a [custom Pieces OS URL](/product-highlights-and-benefits/connecting-to-a-remote-pieces-os-instance), you can enter it here. This is useful if you're using a self-hosted version of Pieces OS.
