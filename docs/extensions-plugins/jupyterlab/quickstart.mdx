...
1. Install the extension:
    ...
    1. If you want to use the JupyterLab UI to install, select the __Extension Manager__, search for `Pieces`, then select __Install__ for the `jupyter-pieces` extension.
...
1. From your code cell, select all the code, right click and select _Ask Pieces about your selection_.
