---
title: Save a Code Snippet with AI Context Using the Pieces for Developers JupyterLab Extension
description: Learn how to save a code snippet in the Pieces for Developers JupyterLab Extension and add additional context using AI.
---
