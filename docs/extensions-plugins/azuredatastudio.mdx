...
description: Learn about the Pieces Azure Data Studio Extension, how it functions, and what all you can do with this powerful extension in ADS from Microsoft.
---

<link rel="canonical" href="https://docs.pieces.app/extensions-plugins/azuredatastudio" />

export const InstallButton = props => {
    return <a style={{textDecoration: "none"}} target="_blank" href="{{ links.extensions.azureds }}">
...
export const HeaderLogoImage = props => {
    return <img style={{ marginTop: "0px", marginBottom: "1em", width: "50%" }} src={ "/assets/ads_logo.png" }/>
}
...
<GridFlexRow>
    <h1>Pieces Azure Data Studio Extension</h1>
</GridFlexRow>

<GridFlexRow>
    <InstallButton>Get the Azure Extension</InstallButton>
    <ReleasePill children="Current Version: {{ versions.azureds }}"></ReleasePill>
</GridFlexRow>

## Installing the Extension
<Info>In order to use the Pieces for Azure Database Extension, you must have <a target="blank" href="/installation-getting-started/what-am-i-installing">Pieces OS.</a> We recommend also using the Pieces for Developers desktop app.</Info>

You can install the Azure Extension by [downloading it on this link](/#) or by searching for Pieces in the plugins search of your IDE.

Once you've installed the extension, you'll have to restart ADS before using Pieces.
...
### Cloud Capabilities
Here you can choose which type of ML models you'd like to use in Pieces for Azure Data Studio : Cloud, Local, or Blended. To learn more about the types of ML models and their privacy implications, [visit this section of our documentation](https://docs.pieces.app/product-highlights-and-benefits/privacy-security-data#our-machine-learning-models).
...
<Info>After installing or updating your software, please restart Azure Data Studio . If there is still a problem, [reach out to our support](https://getpieces.typeform.com/to/mCjBSIjF#docs-vscode).</Info>
