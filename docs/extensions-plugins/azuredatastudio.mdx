...
export const AzureLogo = props => {
    return <img style={{ marginTop: "1em", marginBottom: "1em", width: "50%" }} src={"/assets/ads_logo.png"} />
}
...
<GridFlexRowBaseline>
<AzureLogo src="/assets/ads_logo.png"></AzureLogo>
...
You can install the Azure Extension by [downloading it from this link](https://builds.pieces.app/stages/staging/plugin_vscode/ads-vsix/download) or by searching for Pieces in the plugins search of your IDE.
...
- Pieces OS version 7.0.0 or higher
