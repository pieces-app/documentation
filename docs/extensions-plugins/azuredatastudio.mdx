...
You can install the Azure Extension by [downloading it on this link](https://builds.pieces.app/stages/staging/plugin_vscode/ads-vsix/download) or by searching for Pieces in the plugins search of your IDE.
...
1. Open up ADS in any project
2. Click on "Extensions" in the sidebar on the left
3. Click the '...' in the top right of te viewer on the left side of your IDE
4. Select "Install from VSIX" at the bottom of the context menu that opens
5. Then select the `ads-out.vsix` file ansd press choose
