...
It’s important to download and [install Pieces OS and the Pieces Desktop App](https://docs.pieces.app/what-am-i-installing). Create an account or sign in with the email you use for Microsoft Teams. This will allow you to connect Pieces and Teams.
...
![Asking Pieces a question inside of a Microsoft Teams chat.](https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/MICROSOFT_TEAMS/WINDOWS/ANY_FEATURE/16X9/PIECES_FOR_DEVELOPERS-MICROSOFT_TEAMS-ANY_FEATURE-WINDOWS-16X9-5_21_2023.GIF)
