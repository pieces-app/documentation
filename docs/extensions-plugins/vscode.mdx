...
export const VSCodeLogo = props => {
    return <img style ={{marginTop: "0px", marginBottom: "1em", width: "50%"}} src={"/assets/vscode_logo.png}/>
}
...
<GridFlexRow>
<VSCodeLogo src="/assets/vscode_logo.png"></VSCodeLogo>
...
<Image zoom src="https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/GLOBAL_COPILOT/16X9/PIECES_FOR_DEVELOPERS-VS_CODE-GLOBAL_COPILOT-MACOS-16X9-1_10_2024.GIF" />
...
<Image zoom src="https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/ANY_FEATURE/16X9/10-pieces-fix.gif" />
...
<Image zoom src="https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/ANY_FEATURE/16X9/PIECES_FOR_DEVELOPERS-VS_CODE-ANY_FEATURE-MACOS-16X9-1_10_2024.GIF" />

4. <a href='/features/copilot-plugin'>A familiar chat experience spread across all your favorite text editing softwares</a>
