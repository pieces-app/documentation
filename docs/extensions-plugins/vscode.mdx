...
**Note:** In order to use the Pieces VS Code Extension, you must have <a target="blank" href="{{ links.website.pfd_desktop_intall }}">Pieces OS.</a> We recommend also using the Pieces for Developers desktop app.
