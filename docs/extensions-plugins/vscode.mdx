...
1. **Ask Copilot**
    - Ask the Copilot about a file, folder, snippet, code fragment, or terminal output. All available by right-clicking, and then selecting 'Ask Copilot'.
      <Video type={'youtube'} src={'https://www.youtube.com/embed/USseqXowKDE?si=a5k8wdWhSKRROoNO'} alt={'Ask Copilot'} />
...
2. Right Click
    ...
    [//]: # (<Video type={'gif'} src={'https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/RIGHT-CLICK_SAVE/16X9/PIECES_FOR_DEVELOPERS-VS_CODE-RIGHT-CLICK_SAVE-MACOS-16X9-1_31_2024.GIF.gif'} alt={'Save Snippets'} />)

### Save Files to Pieces
To save an entire file to Pieces, right-click on the file in the file explorer and select `Save File to Pieces`.
...
<Video type={'youtube'} src={'https://www.youtube.com/embed/RmGVi6ffQvI?si=JQ2TC6s0Fw88fsau'} alt={'Preview Snippets in Markdown'} />
...
<Video type={'youtube'} src={'https://www.youtube.com/embed/WgZeDBIin3w?si=C3NaqxoCYYEq0iIL'} alt={'Edit Snippets in VS Code'} />
...
<Video type={'youtube'} src={'https://www.youtube.com/embed/QgnHxpOmtdA?si=JAWazx6JmNtVuzX2'} alt={'Search for Snippets in VS Code'} />
