...
In order to use the Pieces VS Code Extension, you must have <a target="blank" href="/docs/installation-getting-started/what-am-i-installing">Pieces OS.</a> We recommend also using the Pieces for Developers desktop app.
...
### Cloud Capabilities
Here you can choose which type of ML models you'd like to use in Pieces for VS Code: Cloud, Local, or Blended. To learn more about the types of ML models and their privacy implications, [visit this section of our documentation](/docs/product-highlights-and-benefits/privacy-security-data#our-machine-learning-models).
