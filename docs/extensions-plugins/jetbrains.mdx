...
export const JetBrainsLogo = props => {
    return <img style ={{marginTop: "0px", marginBottom: "1em", width: "50%"}} src={"/assets/jetbrains_logo.png}/>
}
...
<GridFlexRowBaseline>
<JetBrainsLogo src="/assets/jetbrains_logo.png"></JetBrainsLogo>
    <h1>Pieces JetBrains Plugin</h1>
</GridFlexRow Baseline>
...
<Info>In order to use the Pieces JetBrains Plugin, you must have <a target="blank" href="/installation-getting-started/what-am-i-installing">Pieces OS.</a> We recommend also using the Pieces for Developers desktop app.</Info>
...
<Info>To opt-out of Suggested Save, go to `Preferences, Tools, Pieces` and click on Suggested Save.</Info>
