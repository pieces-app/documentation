...
2. Double-tap the shift key and switch to the Pieces tab _or_ Use the ```Ctrl + ⇧ + P``` (\[⌘⇧P\] on macOS) keyboard shortcut to open a tab focused solely on your Pieces snippets
