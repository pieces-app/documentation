...
<Video type={'gif'} src={'https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/GLOBAL_COPILOT/16X9/PIECES_FOR_DEVELOPERS-VS_CODE-GLOBAL_COPILOT-MACOS-16X9-1_10_2024.GIF'} alt={'Ask Copilot'} />
2. **Pieces: Fix**
...
<Video type={'gif'} src={'https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/ANY_FEATURE/16X9/10-pieces-fix.gif'} alt={'Pieces: Fix'} />
...
<Video type={'gif'} src={'https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/ANY_FEATURE/16X9/PIECES_FOR_DEVELOPERS-VS_CODE-ANY_FEATURE-MACOS-16X9-1_10_2024.GIF'} alt={'Pieces: Comment & Pieces: Explain'} />
