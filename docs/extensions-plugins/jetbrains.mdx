...
In order to use the Pieces JetBrains Plugin, you must have <a target="blank" href="/docs/installation-getting-started/what-am-i-installing">Pieces OS.</a> We recommend also using the Pieces for Developers desktop app.
...
With the Pieces for Jetbrains plugin, there are multiple LLMs that you can utilize depending on the model you prefer for your specific environment. You can read more about the different copilot models that you can choose from on [this page](/docs/features/pieces-copilot).
