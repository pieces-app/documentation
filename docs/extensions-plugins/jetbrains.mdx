...
Utilize the Pieces Copilot runtime right inside of Pieces for Jetbrains without having to change settings in the desktop application and hae your Copilot right inside of your IDE.

### Select your Copilot Runtime
Inside of the Pieces Jetbrains extension, there are multiple models that you can utilize depending on the model you prefer or need in your specific environment. You can read more about the different copilot models that you can choose from on this page [here](/features/pieces-copilot).

To select your model, open up the Pieces Copilot Chat, and select "Copilot Runtimes" below the text box at the bottom of the chat, and a secondary window will open with model selections. If you have already downloaded a copilot model inside of one of our other products, it should be available for you here as well.

Each of these runtimes are located in the dropdowns that are in the new dialog, where you can select local or cloud models respectively. If you **do not** already have the runtimes downloaded, you can select and switch immediately, while other local runtimes you may have to download to your machine.

Using local models allows for the same flexibility as Pieces for Developers to work in an offline environment and run more powerful models locally on your machine based on your specific context.

## Real Time Snippet Streaming
Each of the plugins and extensions talk to [Pieces OS](/installation-getting-started/pieces-os) in order to get information about your context, snippets - running in the background between each instance. When you update snippets inside of the Desktop Application - such as a name or description, tags or any of the other metadata, those changes are also reflected in your Jetbrains Sidebar where your snippets are stored without having to refresh.

**If your snippets are not updating right away, try pressing the refresh button located on the top of your snippets list window.
