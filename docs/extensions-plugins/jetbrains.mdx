...
We just launched brand new [documentation for the Pieces for JetBrains Plugin](https://docs.pieces.app/products/extensions-plugins/jetbrains)!

Check it out on our new documentation site and leave us some feedback.

<CTAButton
  href="https://docs.pieces.app/products/extensions-plugins/jetbrains"
...
1. **Ask Copilot**
    ...
    <Video type={'local'} src={'/jetbrains/pieces-copilot'} alt={'Ask Copilot'} />
2. **Pieces: Fix**
...
4. [A familiar chat experience spread across all your favorite text editing softwares](/features/pieces-copilot#plugin-integrations)
...
<Video type={'local'} src={'/jetbrains/view-saved-snippets'} alt={'View Saved Snippets'}/>
...
<Video type={'local'} src={'/jetbrains/snippets-in-markdown'} alt={'Preview Saved Snippets in Markdown'} />
...
<Video type={'local'} src={'/jetbrains/edit-snippets'} alt={'Edit Snippets with the JetBrains Plugin'} />
...
<Video type={'youtube'} src={'https://www.youtube.com/embed/FYLiJVti3SM?si=HHqT9soVyI-MFmSO'} alt={'Suggested Save'} />
...
<Video type={'youtube'} src={'https://www.youtube.com/embed/VMYbKSwfbJ4?si=K3UY-wWPyg1nBYNi'} alt={'Related Materials'} />
...
If you can't find the Pieces for Developers JetBrains Plugin in the JetBrains Marketplace, you can navigate directly to it with <a target = "blank" href = "https://plugins.jetbrains.com/plugin/17328-pieces--save-search-share--reuse-code-snippets">this link</a>.
