...
#### Further, if you edit the resource or add additional context metadata, [Pieces for Developers]( {{links.website.home}} ) will recommend that you update the link or automatically update it for you. This happens in the background without generating a new access link, meaning previous recipients can stay up-to-date and you don't have to re-share.
