---
title: Single-click Link Sharing
description: Send anyone a sharable link and they will be able to access what you shared and its context metadata, even if the recipient doesn't have Pieces for Developers installed.
---
