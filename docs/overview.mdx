...
##### The debut release of our <a href="{{ links.website.home }}">Flagship Desktop App</a> aims to take developer's _productivity to the next level_, incorporates key capabilities and our users _favorite features directly into their IDE_.
...
Our <a href="{{ links.website.pfd_desktop_install }}">Flagship Desktop App provides users a first-in-kind feature set that ambitiously **_augments your development workflows_**.
