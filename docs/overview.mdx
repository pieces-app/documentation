...
export const Analytics = props => {
    return <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K8C6QWB" height="0" width="0" style="display:none;visibility:hidden">{props.children}</iframe></noscript>
}