...
1. [Backup your current Pieces Database](/learn/features/back-up-and-restore#creating-the-backup) **(Computer #1)**
...
2. [Quit/Turn off Pieces OS](/learn/features/back-up-and-restore#step-1) on both computers
...
2. [Turn Pieces OS off](/learn/features/back-up-and-restore#step-1)
...
**On Computer #1:**
1. [Turn Pieces OS Off](/learn/features/back-up-and-restore#step-1)
...
## Important Notes
- [Pieces OS should be completely turned off](/learn/features/back-up-and-restore#step-1) during the entire syncing process
