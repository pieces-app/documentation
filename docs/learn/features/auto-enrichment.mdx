...
[Learn how to Manage and Update Snippets and their Metadata](/learn/features/managing-saved-materials)
...
Once you enter the Context View, you will see data added both automatically via Pieces' AI & GPT-4, and any enrichments that you have [added manually](/learn/features/managing-saved-materials).
...
Read about all the [ins-and-outs of shareable links](/learn/features/one-click-snippet-sharing).
...
The advantage to saving snippets by [importing them from GitHub gists](/learn/product-highlights-and-benefits/import-gists-from-github) is other users who have commented on the PR, contributed to the repo, or been involved in another way will show up here under related users.
