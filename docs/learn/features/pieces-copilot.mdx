...
3. Drag and Drop a screenshot of code, and the Pieces Copilot will extract the code, explain it, and answer questions about it.
    ...
    - Read about dragging and dropping code into the Pieces Desktop App on the [Saving Screenshots Page](/learn/product-highlights-and-benefits/saving-screenshots).
...
| Action | What it Does |
|---|---|
| Save to Pieces | [Saves the snippet](/learn/product-highlights-and-benefits/saving-useful-developer-materials) to your Pieces repo, so it's available across plugins and extensions. |
| Share | Saves the snippet and generates a [shareable link](/learn/features/one-click-snippet-sharing) to send to another user. |
