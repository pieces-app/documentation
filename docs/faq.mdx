...
>
  <TabItem value="mac_os">
    PiecesOS: Click the `P` icon in your menu bar and view your update status in the dropdown
  </TabItem>
  <TabItem value="windows">
    PiecesOS: Click the PiecesOS icon in your task bar and view in the popup
...
Select Extensions, search Pieces for VS Code, and you’ll see the version next to the title.

### Pieces for JetBrains

Select Settings > Plugins…> search Pieces > see version

### Pieces for Obsidian

Select Settings > Community Plugins > see version under Pieces for Developers

### Pieces for JupyterLab

Select Extension Manager > see version next to jupyter-pieces

---

## Can’t connect to PiecesOS:
...
[//]: # (TODO: Need to add links here)
We should link all of our videos, how-tos, and feature walkthroughs. We will probably always have a lot of feedback from new people since VS Code is so popular, so we should publish as much as we can.
