...
>
  ...
  <TabItem value="linux">
    Follow these steps to debug:
    1. What version of Ubuntu are you currently running? We currently support 22.04 and above.
    ...
    3. In your terminal, print out a debugging log of Pieces OS by using the following command:
    ```sh
    pieces-os --debug
    ```
...
https://github.com/pieces-app/support/discussions/14
...
Please note that removing Pieces will delete all of your data, including code snippets, copilot conversations, and downloaded local LLMs.
