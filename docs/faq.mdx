...
<Tabs defaultValue={"macos"}  values={[{label: 'macOS', value: 'macos'}, {label: 'Windows', value: 'windows'}, {label: 'Linux', value: 'linux'}]}>
 ...
 <TabItem value="windows">
  <CTAButton
    ...
    <p> Before you make the switch, uninstall Pieces OS first and then the Pieces for Developers desktop app to prevent conflicts. Your user-generated dat will not be affected during this change.</p>
  </TabItem>
  <TabItem value="linux">
    <CTAButton
      href={"/faq/linux"}
