...
## How many resources does Pieces use on your machine?

Due to our commitment to providing a very secure experience by leveraging on-device models, Pieces does require a decent amount of resources; 2GB is fairly standard for what we offer today. We are always working to make Pieces more performant, but this is just due to the nature of our implementation.

To make things a little better, you can select "Optimize Memory Usage" in the PiecesOS menu by clicking on the PiecesOS icon in your taskbar. This setting can help reduce the memory footprint and improve performance on your machine.
...
>
  <TabItem value="mac_os">
    ...
    <img src={'/pos/version-macos.png'} alt={'Pieces OS icon in menu bar'} height={400} />
  ...
  <TabItem value="windows">
    ...
    ![Pieces OS Version](/pos/version-windows.png)
  </TabItem>
  <TabItem value="linux">
...
<Video
  type={'local'}
  src={'/assets/faqs/check_pfd_version'}
  maxWidth={'600px'}
/>
...
<img src={'/jetbrains/version.png'} alt={'JetBrains Plugin Version'} width={500} />

### Pieces for Obsidian

Select Settings > Community Plugins > View the version under `Pieces for Developers`

<img src={'/obsidian/version.png'} alt={'Obsidian Plugin Version'} height={400} />

### Pieces for JupyterLab

Select Extension Manager > View the version next to jupyter-pieces

<img src={'/jupyterlab/version.png'} alt={'JupyterLab Plugin Version'} height={400} />
...
>
  <TabItem value="mac_os">
    ...
    3. Ensure PiecesOS is running: you should see the Pieces icon in your menu bar
        ...
        <img src={'/assets/faqs/cannot_connect_to_pieces_os_mac_os.png'} alt={'Pieces OS icon in menu bar'} height={400} />
...
![LLM Crashing](/misc/llm-crashing.png)
...
![Recommended LLM Option](/misc/llm-recommendation.jpeg)
...
Please join [this discussion](https://github.com/pieces-app/support/discussions/14) on GitHub to add your opinion about what distributions we should work on next.
...
1. Choose “Discover” above your Snippet
