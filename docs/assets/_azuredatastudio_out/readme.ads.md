<!-- here we can store all variables for the file -->
...
<!-- (1.4) Link Sharing and Personalization of Context -->
...
<!-- (2) Installation Details and Getting Started -->
