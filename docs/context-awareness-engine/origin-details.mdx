#### When you save something to [Pieces for Developers]( {{links.website.home}} ), it not only saves the material itself; but further, our [Context Awareness Engine and Origin Details] automatically attach related context & metadata, enabling powerful organization, search, and suggestion capabilities.
