...
> See this <a href="{{ links.snippets.python.snippet }}">Shared Python Snippet</a> from <a href="{{ links.snippets.python.collection }}">python.pieces.cloud</a> in your browser. Notice this is from the custom domain, "python".
