...
For more information on the available endpoints, refer to the [Kotlin SDK Docs](https://github.com/pieces-app/pieces-os-client-sdk-for-kotlin/tree/main/docs).
