...
Create a `config.ts` file and add the following code:
...
export const apiInstance = new Pieces.WellKnownApi(configuration)
```
...
Run the TypeScript script to see the output:
