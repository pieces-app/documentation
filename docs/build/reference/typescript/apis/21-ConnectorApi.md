...
------------- | ------------- | -------------
[**connect**](Connector API#connect) | **POST** /connect | /connect [POST]
[**intention**](Connector API#intention) | **POST** /\{application\}/intention | /\{application\}/intention [POST]
[**onboarded**](Connector API#onboarded) | **POST** /\{application\}/onboarded | /onboarded [POST]
[**react**](Connector API#react) | **POST** /\{application\}/reaction | /\{application\}/reaction [POST]
[**suggest**](Connector API#suggest) | **POST** /\{application\}/suggestion | /\{application\}/suggestion [POST]
[**track**](Connector API#track) | **POST** /\{application\}/track | /\{application\}/track [POST]
...
const apiInstance = new Pieces.Connector API(configuration)
