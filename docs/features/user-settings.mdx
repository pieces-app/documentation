...
<Image zoom alt={"User Settings drawer inside of Pieces for Developers Desktop App."} src="../assets/user_settings.png" />
...
This view is your portal to [Global Search](https://docs.pieces.app/features/global-search) and the [Pieces Copilot](https://docs.pieces.app/features/pieces-copilot). This is a great default view if the Pieces Copilot is your most-used feature.
