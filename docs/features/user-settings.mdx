...
You can connect more than one account (e.g., GitHub and Google) to Pieces to perform actions like [Importing Gists from GitHub](/product-highlights-and-benefits/import-gists-from-github). When doing this, there are a few things to look out for:
