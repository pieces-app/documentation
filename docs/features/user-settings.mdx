...
- Connecting with an Email & Password
    ...
    3. Then enter your password and press continue, where you will be redirected to a successful log in screen.
        - You can also select ` Sign up ` to create an account and unlock features like [Snippet Sharing](https://docs.pieces.app/features/one-click-snippet-sharing).
...
_If you sign out you will not have access to generate sharable links or share to GitHub via a Gist._

### Connecting Multiple Accounts
You can connect more than one account (e.g., GitHub and Google ) to Pieces to perform actions like [Importing Gists from GitHub](https://docs.pieces.app/product-highlights-and-benefits/import-gists-from-github). When doing this, there are a few things to look out for:
...
To change your password, please sign out of your Pieces account, then follow the "Forgot Password" flow to reset it. 

If you signed into Pieces with Microsoft, Google, or GitHub, changing your password on those accounts will also change your Pieces password. 
...
### Personal Domain
You can read about your personal cloud domain and shareable links [here](https://docs.pieces.app/features/one-click-snippet-sharing).

## Layout
During onboarding, you can **select your default layout** as either List View or Gallery View. In your settings, you can switch your default selection.
...
Opens the [Pieces Documentation Center](https://docs.pieces.app) (Yes - that's where we are now) in case you need assistance or are looking for details on Pieces.
...
You will likely get a notification as soon as an update is available, but you can also check for updates here. If updates are available, you will be prompted to update. If not, you will receive a notificiation that you are currently up to date.

### Keyboard Shortcuts

**Shortcut:** ` ⌘/CTRL + ; `

This opens a file with all of the available keyboard shortcuts in the application, even if you are offline with no connection to the internet.
...
#### Updates
Changing data in snippets with previously generated [shareable links](https://docs.pieces.app/feaures/one-click-snippet-sharing) causes them to update. If you want to hide the notifications that ask you if you would like to update your shareable link with new context, just select the checkbox here.
