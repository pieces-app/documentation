...
**Critical**: Shows important messages such as [confirmations when deleting tags, related links, and more](#)

**All**: Will show all notifications including confirmations of copy + paste and all deletion events
