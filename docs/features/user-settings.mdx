...
### Power Tips
Select the lightbulb icon to view a list of power tips for using Pieces. There are 9 power tips that you can view by pressing the ` -> ` arrow. Press ` Esc ` to return back to the application.
