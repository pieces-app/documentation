...
<Image alt={"User Settings drawer inside of Pieces for Developers Desktop App."} src="/assets/user_settings.png" />
...
You can connect more than one account (e.g., GitHub and Google) to Pieces to perform actions like [Importing Gists from GitHub](/docs/product-highlights-and-benefits/import-gists-from-github). When doing this, there are a few things to look out for:
...
This view is your portal to [Global Search](/docs/features/global-search) and the [Pieces Copilot](/docs/features/pieces-copilot). This is a great default view if the Pieces Copilot is your most-used feature.
...
**Note:** Choosing local-only processing ensures that your code remains solely on your device. Learn more about [Privacy & Data Security](/docs/product-highlights-and-benefits/privacy-security-data) at Pieces to determine which processing mode is best for you.
...
Read more about our [Privacy & Data Security](/docs/product-highlights-and-benefits/privacy-security-data) to get a full look.
