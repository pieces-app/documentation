...
<Video type={'youtube'} src={'https://www.youtube.com/embed/EKTr5Qn0hak?si=OU2oCZoVKw32hn64'} alt={'Power Menu in the Pieces Desktop Application'} aspectRatio={'1.28'} />
...
<Video type={'youtube'} src={'https://www.youtube.com/embed/fUZJ-QjcV8o?si=S_BT-ft49I2ggAkb'} alt={'Power Menu in the Pieces Desktop Application is relevant to what you are using'} aspectRatio={'1.28'} />
...
<Video type={'youtube'} src={'https://www.youtube.com/embed/VlwaH7HfuE8?si=aWAXVXRU4CDa9nGP'} alt={'Access resources using the Power Menu in the Pieces Desktop Application'} aspectRatio={'1.28'} />
