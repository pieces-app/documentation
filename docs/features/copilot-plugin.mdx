...
2. **Select multiple different LLM runtimes, including local LLMs for offline, airgapped security**
    - We have an extensive list of LLMs to choose from depending on your use case including GPT-3.5, GPT-3.5 16k, GPT-4, Gemini as well as local LLMs such as Llama2 with Mistral coming very soon.
