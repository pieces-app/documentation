# Pieces for Developers Copilot Plugin

## Your personalized Copilot, accross all your favoite integrations
...
4. **Utilize directives to quickly reuse matierials as context**
...
5. **Slash commands to perform quick actions**
    - Quickly find related people, save snippets, comment code, and more by by using a / command in the input box.

6. **Go back to your past conversations at any time**
    - Searchable persistent conversations allow you to go back and see all your past interactions with the Copilot, synced accross all our integrations.
