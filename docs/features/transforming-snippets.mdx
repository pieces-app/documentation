...
> These Transformations are currently in Beta - please <a href="https://getpieces.typeform.com/to/mCjBSIjF">share any feedback</a> so that we can continue to make them more useful!
...
We've also improved the Snippet Editing experience by moving the Edit icons to the Action Toolbar and allowing you to exit editing by clicking outside the edit window.