...
In order to access the snippet transformations, first you need to [save your first code snippet](/docs/product-highlights-and-benefits/saving-useful-developer-materials). Once you have code in the Pieces Desktop App:
