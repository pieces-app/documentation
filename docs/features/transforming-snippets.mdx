...
1. Use ` cmd/ctrl + e ` or select **Edit this snippet** which will open up the [edit Mode View](/features/managing-saved-materials) and will change the icons on the Quick Action Menu
