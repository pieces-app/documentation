...
In order to access the snippet transformations, first you need to [save your first code snippet](/product-highlights-and-benefits/saving-useful-developer-materials). Once you have code inside of the Pieces Desktop App:
1. Use ` cmd/ctrl + e ` or click **Edit this snippet** which will open up the Edit Mode, and change the icons on the Quick Action Menu
