...
4. Once you select a specific transformation for a snippet, Pieces will keep track of it and mark the transform icon with a green checkmark if you have already performed that specific transformation.
