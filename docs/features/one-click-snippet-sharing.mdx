...
Sharing as a Gist is a great alternative to Shareable Links if you want to post the code to your [public gists,](/product-highlights-and-benefits/import-gists-from-github) so it is accessible to more people without having to send individual links.
