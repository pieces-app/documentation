...
![Creating a custom subdomain.](https://storage.googleapis.com/pieces_static_resources/pfd_wiki/CUSTOM_SUBDOMAIN.gif)
...
![Saving a shared snippet from the web.](https://storage.googleapis.com/pieces_static_resources/vs_code_marketplace/GIFs/SAVE_FROM_WEB.gif)
