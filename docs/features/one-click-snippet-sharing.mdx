...
Sharing as a Gist is a great alternative to Shareable Links if you want to post the code to your [public gists,](/docs/product-highlights-and-benefits/import-gists-from-github) so it is accessible to more people without having to send individual links.
...
Claiming your custom domain can be done from the Pieces Desktop App **only** - so be sure to [get the app](/docs/installation-getting-started/what-am-i-installing) if you want to claim your unique domain.
...
- Google Chat
- Microsoft Teams ([We have an app for that!](/docs/extensions-plugins/teams))
