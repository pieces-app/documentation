...
Pieces for Developers auto-generates descriptions and other annotations, but you can manually add or reclassify information. To add or edit an annotation, go to the Context Menu and click the Annotations box, or use the keyboard shortcut `⌘/CTRL + ⇧ + N`.
...
<Video
  type={'local'}
  src={'/pfd/enrichment/auto-generated'}
/>
...
<Video
  type={'local'}
  src={'/pfd/enrichment/related-links'}
/>
...
<Video
  type={'local'}
  src={'/pfd/enrichment/related-people'}
/>
...
<Video
  type={'local'}
  src={'/pfd/enrichment/security-practices'}
/>
