...
From inside the Related Links drawer, you can add new links by typing or pasting them directly into the text box at the top. Not all text input will be accepted, so it is important to add **a full http url** such as: [https://docs.pieces.app/](https://docs.pieces.app/).
