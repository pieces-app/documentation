---
title: Auto Enrichment of Developer Materials | Pieces
description: Learn how Pieces for Developers uses ML and AI with ChatGPT to enrich your code snippets with relevant context and metadata.
---
...
Pieces processes your saved materials completely in the background, giving you the ability to access more data around your resources and code snippets. You can view the information by:
...
- [In Gallery View] click _manage context_ on the overlay when hovering the 'view all context' button or press the 'view all context' icon itself
...
Once you enter the Context View, you will see data added both automatically via Pieces' AI & GPT-4, as well as any enrichments that you have [added manually](/features/managing-saved-materials).
...
You can press the entire _description_ box, or use the ` cmd/ctrl + shift + N ` shortcut to edit the contents of the description context field.
...
**Smart Description**
    - We auto-generate this description of the saved snippet with AI to empower search-ability, reference of your list of snippets, and general organization
        - This feature becomes very helpful to identify what a code snippet's purpose is if you lose track of the purpose

**Suggested Searches**
    - These are accurate search terms that you can use to find snippets that are similar to the resource they are attached to. These are pre-generated examples comparable to the examples found on the [Global Search](/features/global-search) feature in the Desktop App.
...
Open the Tags drawer by clicking anywhere overtop of the tags section, or by pressing the ` cmd/ctrl + t ` shortcut. This will bring pull up a list of tags that have already been added when you saved the resource, along with suggested tags that you can click on to quickly add to the snippet.

To create a custom tag, you can start typing once the drawer opens and add any tag you'd like directly into the pre-existing tags list.
...
**Auto Generated**
- tags that are added the moment you save a resource to Pieces, and contain a `sparkle` icon proceeding the tag name.
...
**Custom Tags**
- tags that you can write yourself and add to your code, that will not contain the sparkle icon.
...
From inside the Related Links drawer, you can add new links by typing them directly into the text box at the top. Not all text input will be accepted, so it is important to add **a full http url** such as the following: [https://docs.pieces.app/]()
...
- A confirmation drawer will open up, where you can confirm the removal by pressing the ` delete ` key
    - You can also press ` enter ` or ` return `
...
Shareable links are accessible from this view, and can be opened using the ` cmd/ctrl + l ` shortcut or by clicking on the section inside the Context View. This will open the Shareable Link drawer where you can manage the shareable link for a specific resource.

**Note that all code snippets and resources have their own unique shareable link, and each have to be generated on their own.**
...
<Image alt={"Showing related people on a snippet with a shareable link."} zoom src="https://storage.googleapis.com/pieces_static_resources/pfd_wiki/RELATED_PEOPLE.gif" />
...
If a related person is added to your list of People and you wish to remove it, you can do so by clicking the ` edit ` pencil icon when you hover over the related person in the Related People drawer. Once you are in the edit drawer, you can click ` delete ` next to the ` save ` Button on the bottom of the drawer and the person will be removed.
