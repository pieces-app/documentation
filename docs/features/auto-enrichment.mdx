...
- (optional) you can select **"Do not ask me again"** to quickly delete a number of tags from a snippet in the future, but we recommend keeping this setting turned on to protect against accidental deletions.
...
From inside the Related Links drawer, you can add new links by typing them directly into the text box at the top. Not all text input will be accepted, so it is important to add **a full http url** such as the following: [https://pieces.app/blog](https://pieces.app/blog)
