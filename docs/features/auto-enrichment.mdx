...
## Origin Details
When you save something to <a target="_blank" href="{{ links.website.home }}">Pieces for Developers</a>, it not only saves the material itself; but further, our Context Awareness Engine and Origin Details automatically attach related context & metadata, enabling powerful organization, search, and suggestion capabilities.
...
With <a target="_blank" href="{{ links.website.home }}">Pieces for Developers</a>, you can quickly associate URLs to external resources like Documentation Pages, Wiki Links, Jira Tickets, Pull Requests, and <a target="_blank" href="{{ links.internal.personalized_link_sharing.share_via_github_gist }}">GitHub Issues </a>with your saved materials.
