...
1. Pressing ` ⌘ + I ` or ` CTRL + I ` to access the Context View
...
To edit your snippet's description, you can click the entire description box or use the ` ⌘/CTRL + Shift + N ` shortcut.

This section will be filled out by default, and you can reference the following example:
...
By default, this is filled with, "Write a custom description." This is a space for you to write your own description.

**Smart Description**

We auto-generate this description of the saved snippet with AI to empower search-ability, referencing your list of snippets, and general organization.

This feature becomes very helpful to identify what a code snippet does if you lose track.

**Suggested Searches**

These are accurate search terms that you can use to find snippets that are similar to the resource they are attached to, or to find this resource in the future. These are pre-generated examples comparable to the examples found on the [Global Search](/features/global-search) feature in the Desktop App.
...
The advantage to saving snippets by [importing them from GitHub gists](/product-highlights-and-benefits/import-gists-from-github) is other users who have commented on the PR, contributed to the repo, or been involved in another way will show up here under related users.
