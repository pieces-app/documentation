...
_You can modify the search mode that you have set at any time by selecting the dropdown next to the hourglass search icon to the left of the Search input._
