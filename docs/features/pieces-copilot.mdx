...
- Gemini, a model trained by Google which is especially good at explaining reasoning in complex subjects like math and physics.
    - *This model requires 5.6GB of RAM and 5.6GB of VRAM.*
