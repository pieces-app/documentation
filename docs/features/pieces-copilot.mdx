...
### Workstream Context
The [Workstream Pattern Engine](/product-highlights-and-benefits/workstream-context) introduces a temporally grounded aspect to the Copilot, making it aware of your recent activities and discussions. This dynamic understanding allows the Copilot to provide contextually aware interactions and suggestions based on your latest workstream.

By enabling the Workstream Pattern Engine in the Pieces settings, the Copilot can reference your recent activities, discussions, and code changes, enhancing its responses and interactions.

#### Temporal and Conversational Awareness
This feature allows for a more intuitive and seamless interaction with the Copilot, as it can recall and reference recent work contexts and discussions. Whether you're asking about a recent error or a discussion point with a colleague, the Copilot uses its temporally grounded knowledge to provide relevant and timely assistance.
