...
Disclaimer: Running Large Language Models locally on-device is typically resource intensive. As of right now a majority of our Local LLMs leverage roughly 7 billion parameters and to ensure optimal performance, we recommend the following minimum specifications:
- **CPU:** A modern, multi-core processor with at least 4 cores.
- **RAM:** At least 8GB of system memory.
- **GPU (Optional):** A dedicated GPU with at least 4 GB of VRAM (NVIDIA RTX 20 series or newer recommended).
