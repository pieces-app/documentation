...
- By clicking inside of the box where the code is in the center of the screen, you can edit the snippet directly
...
When you need to transform or make slight adjustments to a code snippet you already have, you can duplicate a snippet with ` CMD/CTRL + D `, or by selecting the ` Duplicate + ` pill above your code in List View, and below it in Gallery mode.
...
When working with transformations, saving the original can be beneficial in case a snippet transformation does not come back well. There is a `Save as Duplicate +" pill that can be selected to save the original and the new transfromed versions.

[Learn more about Transformations](/features/transforming-snippets) to understand the full benefit!
