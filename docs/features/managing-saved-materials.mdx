...
- You can also [access transformations](/docs/features/transforming-snippets) that can create boilerplate code, add comments for you, and more.
...
Before renaming snippets, be sure to read about our [AI title generation](/docs/features/auto-enrichment) to get an idea of how title generation takes place.
...
[Learn more about Transformations](/docs/features/transforming-snippets) to understand the full scope of things you can do!
