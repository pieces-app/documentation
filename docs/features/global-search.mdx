...
description: Use Global Search to discover snippets you have saved based on what problems they solve, without even mentioning the language or code syntax.
---
...
To access Global Search in the Pieces Desktop App, select Global Search from the dropdown menu in the upper left corner where other views like [Workflow Activity](/features/workflow-activity) and [Snippet Discovery](/product-highlights-and-benefits/in-project-snippet-discovery) live.
...
1. The snippets that match your results will be in vertical cards containing:
    ...
    - A related link to the source that the resource came from e.g. saved using the [Chrome Extension](/extensions-plugins/chrome)
