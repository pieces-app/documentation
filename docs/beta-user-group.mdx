...
## Communication
Our main form of communication will be via Discord, so please join our discord using [this link](https://discord.gg/qPd2748b7s) if you haven’t already, which will place you in the beta group channel. If you’re already a Discord user please DM [mason-at-pieces](https://discord.com/users/112015890194706432) on Discord, and he will add you to the channel.
