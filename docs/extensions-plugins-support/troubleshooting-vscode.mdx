...
export const InstallButton = props => {
    return <a style={{textDecoration: "none"}} href="{{ links.extensions.vscode }}">
...
<Image zoom src="https://storage.googleapis.com/pieces_static_resources/vs_code_marketplace/GIFs/EDIT_A_SNIPPET.gif" />
...
<Image zoom src="https://storage.googleapis.com/pieces_static_resources/vs_code_marketplace/GIFs/ATOMIC_AUTO_COMPLETE_VS_CODE.gif" />

Save your settings, and you're good to go!

## Search for snippets in Visual Studio Code
<Image zoom src="https://storage.googleapis.com/pieces_static_resources/vs_code_marketplace/GIFs/SEARCH_AND_REUSE_VS_CODE.gif" />
