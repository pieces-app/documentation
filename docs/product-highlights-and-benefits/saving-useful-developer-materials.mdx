...
<Image zoom src="https://storage.googleapis.com/pieces_static_resources/pfd_wiki/DROP_A_FILE" />
...
### Images & Screenshots
To save an image or screenshot, you can either drag the image directly into the <a target="_blank" href="{{ links.website.home }}">Flagship Desktop App</a> window, or you can _upload a file_ by clicking the "Add +" button above the icons in the carousel.
