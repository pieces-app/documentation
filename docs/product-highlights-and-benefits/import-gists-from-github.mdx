...
Import saved code from GitHub with the <a target="_blank" href="{{ links.website.home }}">Pieces for Developers | Desktop App</a>. When you import Gists, Pieces attaches metadata from the original repo along with PRs, related people, and additional context.
