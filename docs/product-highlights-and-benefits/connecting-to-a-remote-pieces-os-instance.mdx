...
- Remote development environments (e.g. [GitHub Codespaces](https://github.com/features/codespaces), [Windows Subsystem for Linux](https://learn.microsoft.com/en-us/windows/wsl/about), SSH connection, Development Containers)
