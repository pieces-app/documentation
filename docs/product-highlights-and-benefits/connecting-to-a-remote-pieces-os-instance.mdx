...
> - This is currently only available for the Pieces for Developers VS Code extension. We are working on adding this functionality to the rest of the Pieces for Developers ecosystem.

## Use Cases

- You want to use Pieces in a remote development environment (i.e. GitHub Codespaces)
