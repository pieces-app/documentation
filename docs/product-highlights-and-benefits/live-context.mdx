---
title: Live Context
description: Powered by Workstream Pattern Engine, Live Context can now understand recent workstream contexts, eliminating the need for manual grounding.
---
...
This feature is currently in `Alpha` and now available to all macOS & Windows users, with support for Linux coming ASAP.
...
To engage with workstream context, turn on Live Context by clicking the button in the "Set Context" region of the new chat, or via the "Context" button to the left of the Copilot Input.
