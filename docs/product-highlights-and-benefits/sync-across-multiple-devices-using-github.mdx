...
<Info>Note: This is a manual process and is still in early beta. In the meantime, if you have any issues with the process below please do not hesitate to [contact us](https://getpieces.typeform.com/to/mCjBSIjF#page=docs-syncing-across-devices).</Info>
