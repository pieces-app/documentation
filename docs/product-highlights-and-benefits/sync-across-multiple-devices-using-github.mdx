...
description: Follow this guide to get started with manually syncing your code snippets on multiple devices without authenticating with Pieces.
---
...
**You can now easily backup, restore, and sync your snippets across multiple devices using our new [Backup & Restore feature](/features/back-up-and-restore).**
...
1. [Backup your current Pieces Database](/features/back-up-and-restore#creating-an-offline-backup) **(Computer #1)**
...
2. [Quit/Turn off Pieces OS](/features/back-up-and-restore#step-1-quit-pieces-os-and-pieces-desktop) on both computers
...
2. [Turn Pieces OS off](/features/back-up-and-restore#step-1-quit-pieces-os-and-pieces-desktop)
...
**On Computer #1:**
1. [Turn Pieces OS Off](/features/back-up-and-restore#step-1-quit-pieces-os-and-pieces-desktop)
...
## Important Notes
- [Pieces OS should be completely turned off](/features/back-up-and-restore#step-1-quit-pieces-os-and-pieces-desktop) during the entire syncing process
