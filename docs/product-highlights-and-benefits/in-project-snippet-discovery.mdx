...
2. Select Files:
    ...
    This allows you to select a single file or multiple files. Once the [File Picker](/docs/product-highlights-and-benefits/saving-useful-developer-materials#pieces-desktop) opens, select a single file and press 'Open' or hold ``` ⌘/CTRL ``` while you select multiple files.
...
4. Select Gists:
    ...
    [Learn more about Pieces GitHub and Gists](/docs/product-highlights-and-benefits/import-gists-from-github)
