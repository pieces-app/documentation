...
# Sync Snippets Across Multiple Devices using GitHub
...
2. Version control account (GitHub, GitLab, etc.)
...
4. Open the following folder in your IDE or terminal:
    ...
    - Windows/Linux: `~/Users/user/Documents/com.pieces.os/production/Pieces`
...
7. Now go to your browser and follow these steps to create a private repository (Used GitHub but is similar on other VCSs):
    ...
    5. Select the owner to be whoever you want to own this (We recommend to be your personal account)
...
11. Open the following folder in your IDE or terminal:
    ...
    - Windows/Linux: `~/Users/user/Documents/com.pieces.os/production`
...
- This only syncs snippets, not any other data.
