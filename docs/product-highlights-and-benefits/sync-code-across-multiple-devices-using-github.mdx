---
title: Sync Snippets Across Multiple Devices using GitHub
...
> Note: This is a manual process for now, but we will be adding an in-app backup/sync experience in Q1 of 2024. In the meantime, if you have any issues with the process below please do not hesitate to [contact us](https://getpieces.typeform.com/to/mCjBSIjF#page=docs-syncing-across-devices).

This guide uses VS Code since it is free and the steps for configuration are not to advanced. This can be followed using any version control flow that you use.
...
## Prerequisites
- Two (2) computers with Pieces OS and Pieces Desktop App already installed
    - Computer #1: Computer where your saved snippets are currently saved
    - Computer #2: Other computer where you want to sync your snippets to
- Version control account (GitHub, GitLab, etc.)

**You should start this guide on the computer that has your snippets saved on it.**

## Setup Steps (15-20 minutes):
1. [Backup your current Pieces Database](https://docs.pieces.app/features/back-up-and-restore#creating-the-backup) **(Computer #1)**
    a. This is very important to ensure you do not lose any snippets or files during the syncing process in case something goes wrong
2. [Quit/Turn off Pieces OS](https://docs.pieces.app/features/back-up-and-restore#step-1) on both computers
    a. Ensure it is off until the guide specifically tells you to turn it back on
...
4. Open the following folder in your IDE or terminal:
    a. MacOS: `~/Users/user/Library/com.pieces.os/production/Pieces`
    b. Windows/Linux: `~/Users/user/Documents/com.pieces.os/production/Pieces`
...
6. (Optional) Create a .gitignore file and paste the following into the file to ensure you don’t commit any IDE-specific files:
    ...
    ```
7. Now go to your browser and follow these steps to create a private repository (Used GitHub but is similar on other VCSs):
    a. If you are using VS Code, you can **skip to step #7** because it will automatically create a new repository for you
    b. go to [https://github.com](https://github.com)
        - If you are not signed in, please sign in to your GitHub account or create a new account if you do not already have one
    c. Click the “Create new…” dropdown button in the top right corner
        ![Image here](/)
    d. Click “New repository” from the dropdown
    e. Select the owner to be whoever you want to own this (We recommend to be your personal account)
    f. Name the repository anything you want (The recommended name is Pieces)
    g. Set the repository visibility to **Private**
    h. Click "Create repository"
    i. Copy the HTTPS link that should be in the “Quick setup” section of the page
...
8. Now we will commit and push your snippets to the remote repository:
    a. Go to your IDE or terminal you have open from step #3
    b. Stage and commit all changes
    c. Create a new repository or connect your previously created repository using the HTTPS link you copied
    d. Push your changes to the connected repository
...
11. Open the following folder in your IDE or terminal:
    a. MacOS: `~/Users/user/Library/com.pieces.os/production`
    b. Windows/Linux: `~/Users/user/Documents/com.pieces.os/production`
12. Delete the following folder named **Pieces**:
    a. MacOS: `~/Users/user/Library/com.pieces.os/production/Pieces`
    b. Windows/Linux: `~/Users/user/Documents/com.pieces.os/production/Pieces`
13. Go to [https://github.com](https://github.com)
    a. If you are not signed in, please sign in to the same GitHub account you’ve been using
...
2. [Turn Pieces OS off](https://docs.pieces.app/features/back-up-and-restore#step-1)
...
8. Pull the latest changes from your remote repository:
    a. If there are any merge conflicts, always accept the remote changes
9. Run Pieces OS
...
**On Computer #1:**
1. [Turn Pieces OS Off](https://docs.pieces.app/features/back-up-and-restore#step-1)
...
### Important Notes:
- [Pieces OS should be turned off](https://docs.pieces.app/features/back-up-and-restore#step-1), not running in the background, during the entire syncing process
