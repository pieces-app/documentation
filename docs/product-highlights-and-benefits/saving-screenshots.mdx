...
Sometimes the code you need is not in a location where it can be copied, such as YouTube videos, tutorials, onboarding docs, or messages. **You can capture this code, modify and manipulate it as you wish** by taking a screenshot using ``` cmd + shift + 4 ``` or ``` windowskey + shift + S ```.
