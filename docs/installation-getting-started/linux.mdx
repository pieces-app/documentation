...
To run Pieces for Developers on Linux, be sure to download both of the applications from the [Snap Store](https://snapcraft.io) before installing. You can also follow the instructions below these install buttons to install via terminal.
