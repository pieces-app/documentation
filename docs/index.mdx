...
<GridFlexRow>
    <a href="{{ links.website.pfd_desktop_install }}">![](/assets/pfd_logo.png)</a>
    <a href="{{ links.extensions.chrome }}">![](/assets/chrome_logo.png)</a>
    <a href="{{ links.extensions.jetbrains }}">![](/assets/jetbrains_logo.png)</a>
    <a href="{{ links.extensions.vscode }}">![](/assets/vscode_logo.png)</a>
    <a href="{{ links.extensions.edge }}">![](/assets/edge_logo.png)</a>
</GridFlexRow>
