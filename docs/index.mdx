...
<Grid cols={2}>
  ...
  <CardWithCTA icon={'/assets/pieces_os_light_logo.svg'} darkIcon={'/assets/pieces_os_dark_logo.svg'} title={'Pieces OS'} description={'The OS-level application that powers Pieces for Developers'} href={'/installation-getting-started/pieces-os'} />
</Grid>
