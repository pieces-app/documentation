...
export const QuoteCallout = props => {
    return <div style={{ padding: "10px", border: "1px solid #f3f4f5" }}>
...
export const InstallButton = props => {
    return <a style={{ textDecoration: "none" }} href={"https://pieces.app"}>
        <div style={{ maxWidth: "fit-content", minWidth: "fit-content"}}>
            <p style={{ padding: "2px 20px", borderRadius: "20px", border: "1px solid #000000", fontWeight: "bold", backgroundColor: "#000000" }}>{ props.children }</p>
        </div>
    </a>
}
