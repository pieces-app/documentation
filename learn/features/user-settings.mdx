...
- Connecting with an Email & Password
    ...
    3. Then enter your password and press continue, where you will be redirected to a successful log in screen.
        - You can also select `Sign up` to create an account and unlock features like [Snippet Sharing](/learn/features/one-click-snippet-sharing).
...
You can connect more than one account (e.g., GitHub and Google) to Pieces to perform actions like [Importing Gists from GitHub](/learn/product-highlights-and-benefits/import-gists-from-github). When doing this, there are a few things to look out for:
...
### Personal Domain
You can read about your personal cloud domain and shareable links [here](/learn/features/one-click-snippet-sharing).
...
This view is your portal to [Global Search](/learn/features/global-search) and the [Pieces Copilot](/learn/features/pieces-copilot). This is a great default view if the Pieces Copilot is your most-used feature.
...
#### Updates
Changing data in snippets with previously generated [shareable links](/learn/features/one-click-snippet-sharing) causes them to update. If you want to hide the notifications that ask you if you would like to update your shareable link with new context, just select the checkbox here.
...
**Note:** Choosing local-only processing ensures that your code remains solely on your device. Learn more about [Privacy & Data Security](/learn/product-highlights-and-benefits/privacy-security-data) at Pieces to determine which processing mode is best for you.
...
Read more about our [Privacy & Data Security](/learn/product-highlights-and-benefits/privacy-security-data) to get a full look.
