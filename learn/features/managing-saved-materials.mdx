---
title: Managing Saved Materials | Pieces
...
<Image alt={"Editing a snippet in the Pieces desktop app."} src={"https://storage.googleapis.com/pieces_static_resources/pfd_wiki/EDIT_SNIPPET_PFD.gif"} />
...
- You can also [access transformations](/learn/features/transforming-snippets) that can create boilerplate code, add comments for you, and more.
...
<Image alt={"Renaming a snippet in the Pieces desktop app."} src="https://storage.googleapis.com/pieces_static_resources/pfd_wiki/RENAME_SNIPPET.gif" />

Before renaming snippets, be sure to read about our [AI title generation](/learn/features/auto-enrichment) to get an idea of how title generation takes place.
...
<Image alt={"Reclassifying a snippet in the Pieces desktop app."} src="https://storage.googleapis.com/pieces_static_resources/pfd_wiki/RECLASSIFY_IN_PFD.gif" />
...
[Learn more about Transformations](/learn/features/transforming-snippets) to understand the full scope of things you can do!

## Deleting a Saved Material

<Image alt={"Deleting a snippet in the Pieces desktop app."} src="https://storage.googleapis.com/pieces_static_resources/pfd_wiki/DELETE_SNIPPET.gif" />
