...
<Video
  src={'/assets/personalized-copilot-chats.mp4'}
  type={'mp4'}
/>
...
1. **Chat with any of your materials, anywhere**
    ...
    ![](https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/COPILOT_CONTEXT_GENERIC/16X9/PIECES_FOR_DEVELOPERS-VS_CODE-COPILOT_CONTEXT_GENERIC-MACOS-16X9-1_10_2024.GIF)
2. **Select multiple different LLM runtimes, including local LLMs for offline, airgapped security**
    ...
    ![](https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/COPILOT/16X9/2.select-llm-runtime.gif)
3. **Extract code from images**
    ...
    ![](https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/COPILOT_OCR/16X9/PIECES_FOR_DEVELOPERS-VS_CODE-COPILOT_OCR-MACOS-16X9-1_10_2024.GIF)
4. **Utilize directives to quickly reuse materials as context**
    ...
    ![](https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/ANY_FEATURE/16X9/4.vs-code-directives.gif)
5. **Slash commands to perform quick actions**
    ...
    ![](https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/COPILOT/16X9/vs-code-slash-commands.gif)
6. **Go back to your past conversations at any time**
    ...
    ![](https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/COPILOT/16X9/6.persisted-chats.gif)
7. **Personalized suggested prompts based on your conversation and saved materials**
    ...
    ![](https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/SUGGESTED_MATERIALS/16X9/PIECES_FOR_DEVELOPERS-VS_CODE-SUGGESTED_MATERIALS-MACOS-16X9-1_10_2024.GIF)
8. **Quickly link back to relevant files**
    ...
    ![](https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/COPILOT_CONTEXT_FILES/16X9/PIECES_FOR_DEVELOPERS-VS_CODE-RELATED_FILES-MACOS-16X9-1_31_2024.GIF.gif)
