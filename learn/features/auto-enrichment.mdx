...
<Image alt={"Viewing automatically captured metadata in Pieces for Developers."} src="https://storage.googleapis.com/pieces_static_resources/pfd_wiki/PFD_ORIGIN.gif" />
...
<Image alt={"Saving a snippet from Stack Overflow with the Pieces web extension"} src="https://storage.googleapis.com/pieces_static_resources/pfd_wiki/RELATED_LINKS_EXTERNAL_RESOURCES.gif" />
...
<Image alt={"Showing related people on a snippet with a shareable link."} src="https://storage.googleapis.com/pieces_static_resources/pfd_wiki/RELATED_PEOPLE.gif" />
...
### Security Practices
<Image alt={"Protecting Sensitive information from being shared."} src="https://storage.googleapis.com/pieces_static_resources/pfd_wiki/SENSITIVE.gif" />
