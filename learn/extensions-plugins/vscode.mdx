...
export const InstallButton = props => {
    return <a style={{textDecoration: "none"}} target="_blank" href={pieces_app.links.extensions.vscode }>
...
In order to use the Pieces VS Code Extension, you must have <a target="blank" href="/learn/installation-getting-started/what-am-i-installing">Pieces OS.</a> We recommend also using the Pieces for Developers desktop app.
...
<Image src="https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/GLOBAL_COPILOT/16X9/PIECES_FOR_DEVELOPERS-VS_CODE-GLOBAL_COPILOT-MACOS-16X9-1_10_2024.GIF" />
2. **Pieces: Fix**
...
<Image src="https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/ANY_FEATURE/16X9/10-pieces-fix.gif" />
...
<Image src="https://storage.googleapis.com/pieces_multimedia/PROMOTIONAL/PIECES_FOR_DEVELOPERS/VS_CODE/MACOS/ANY_FEATURE/16X9/PIECES_FOR_DEVELOPERS-VS_CODE-ANY_FEATURE-MACOS-16X9-1_10_2024.GIF" />
...
<Image src="https://storage.googleapis.com/pieces_static_resources/vs_code_marketplace/GIFs/EDIT_A_SNIPPET" />
...
<Image src="https://storage.googleapis.com/pieces_static_resources/vs_code_marketplace/GIFs/SEARCH_AND_REUSE_VS_CODE" />
...
### Cloud Capabilities
Here you can choose which type of ML models you'd like to use in Pieces for VS Code: Cloud, Local, or Blended. To learn more about the types of ML models and their privacy implications, [visit this section of our documentation](/learn/product-highlights-and-benefits/privacy-security-data#our-machine-learning-models).
