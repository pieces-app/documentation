...
export const InstallButton = props => {
    return <a style={{textDecoration: "none"}} target="_blank" href={pieces_app.links.extensions.jetbrains}>
...
In order to use the Pieces JetBrains Plugin, you must have <a target="blank" href="/learn/installation-getting-started/what-am-i-installing">Pieces OS.</a> We recommend also using the Pieces for Developers desktop app.
...
<Image src="https://storage.googleapis.com/pieces_static_resources/jetbrains_marketplace/gifs/TREE_VIEW_JETBRAINS.gif" />
...
<Image src="https://storage.googleapis.com/pieces_static_resources/jetbrains_marketplace/gifs/SMARTDESCRIPTIONS_JETBRAINS.gif" />
...
With the Pieces for Jetbrains plugin, there are multiple LLMs that you can utilize depending on the model you prefer for your specific environment. You can read more about the different copilot models that you can choose from on [this page](/learn/features/pieces-copilot).
...
<Image src="https://storage.googleapis.com/pieces_static_resources/jetbrains_marketplace/gifs/EDIT_SNIPPET_JETBRAINS.gif" />
...
<Image src="https://i.ibb.co/XtRM8pb/suggested-snippet.jpg"/>
...
<Image src="https://i.ibb.co/mN1pVWt/related-snippets.jpg"/>
