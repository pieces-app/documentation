...
Try using <a target="_blank" href="/learn/product-highlights-and-benefits/in-project-snippet-discovery">Snippet Discovery</a> to discover snippets from an existing project or file.
