...
<Image alt={"Saving a snippet to the Pieces desktop app."} src="https://storage.googleapis.com/pieces_static_resources/pfd_wiki/DROP_A_FILE.gif" />
...
- Images (.png, .jpeg, .jpg, .gif)
    - [Learn more about Importing Screenshots](/learn/product-highlights-and-benefits/saving-screenshots)
- Raw Text or Code
- Whole Files
...
When using Pieces for Developers - whether the Desktop App or one of our plugins (see an example of saving in our [Microsoft Teams App](/learn/extensions-plugins/teams)) - there are lots of ways to save developer materials. They can be seperated into _Universal_ and _Specific_ methods as follows:
...
- Via [Snippet Discovery](/learn/product-highlights-and-benefits/in-project-snippet-discovery)
...
[Learn more about Saving in the JetBrains Plugin](/learn/extensions-plugins/jetbrains)

#### VS Code Extension:
- Use `⌘ + Shift + V` or `Windowskey + Shift + V` with code selected to save a new resource

[Learn more about saving in the Pieces VS Code extension](/learn/extensions-plugins/vscode)
...
- Hit the `Copy & Save` button that appears when you hover any code block
    ...
    - Learn more about [Sharing and the Share button](/learn/features/one-click-snippet-sharing) that appears next to 'Copy & Save'
- Use `⌘/CTRL + Shift + S` to save text or code from a website

[Learn more about Saving in the Web Extension](/learn/extensions-plugins/chrome)
