...
<Image alt={"Using Snippet Discovery in the Pieces for Developers desktop app."} src="https://storage.googleapis.com/pieces_static_resources/vs_code_marketplace/GIFs/SNIPPET_DISCOVERY_VS_CODE_MIN" />
...
2. Select Files:
    ...
    This allows you to select a single file or multiple files. Once the [File Picker](/learn/product-highlights-and-benefits/saving-useful-developer-materials#pieces-desktop) opens, select a single file and press 'Open' or hold ``` ⌘/CTRL ``` while you select multiple files.
...
4. Select Gists:
    ...
    [Learn more about Pieces GitHub and Gists](/learn/product-highlights-and-benefits/import-gists-from-github)
